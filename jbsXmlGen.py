...
functions = SubElement(instance, 'functions')
functions.set('nbFunctions', '1')

function = SubElement(functions, 'function')
function.set('name', 'JBSConstraint')
function.set('return', 'int')

parameters = SubElement(function, 'parameters')
